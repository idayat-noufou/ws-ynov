...
-- Modification (PUT)
UPDATE ws_masks SET name = 'mask2bis' WHERE id = 2;
UPDATE ws_entries SET entry_json = '{"entry1": "entry1bis"}' WHERE id = 1;

-- Suppression (DELETE)
DELETE FROM ws_masks WHERE id = 3;
DELETE FROM ws_entries WHERE id = 3;

-- Lecture (GET)
SELECT * FROM ws_masks;
SELECT * FROM ws_entries;`;
